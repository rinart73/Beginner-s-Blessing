...
meta =
{
    ...
    name = "BeginnersBlessing",

    -- Title of your mod that will be displayed to players
    title = "Beginner's Blessing",

    -- Description of your mod that will be displayed to players
    description = "Grants decaying buff for the first 3 player ships.",
    ...
    -- },
    dependencies = {
        {id = "1749930520", min = "0.1"},
        {id = "1722652757", min = "1.2"},
        {id = "Avorion", min = "0.24", max = "0.26.1"}
    },
